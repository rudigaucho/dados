...
$sql2 = mysql_query ("select * from repetida where ccto = '$ccto' and ga = '".$_SESSION['nome']."' and MONTH(data) = MONTH(NOW()) " );
...
?>
<span><strong>EDITAR  REPETIDAS.</strong></span><br><br><br><br> 
<div class="container">
...
<div class="row content">
  ...
  <form class="form" role="form" name="seachform" method="post" action="editar_rep2.php " enctype="multipart/form-data" >
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="ccto" name="ccto"   value="<?php echo $ccto ?>" required>
    </div>
 ...
 <div class="form-group">
     ...
     <textarea class="form-control" rows="5" id="just" name="just" maxlength="300" placeholder="Máximo 300 caracteres"><?php echo $justificativa ?></textarea>
    </div>
...
<label class="radio-inline"><input type="radio" name="optradio" value="NAO" checked>NÃO</label>
