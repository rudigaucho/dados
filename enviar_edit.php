...
$query ="update atividades set cliente='$cliente',ccto='$ccto',tipo='$tipo',endereco='$endereco',contato='$contato',tec='$tec',produto='$prod',velocidade='$velocidade',tenc='$tenc',cordial='$cordial',quali='$quali',estacao='$estacao',ard='$ard',quali_ard='$quali_ard',padrao='$padrao',obs='$obs' where protocolo = '$protocolo'";
