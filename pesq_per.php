 ...
 <nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <?php if ($_SESSION["acesso"] != 'GER') {?>

      <li class="active"><a href="consulta.php">Busca por ccto</a></li>
...
$data = $_POST['date'];
$data2 = $_POST['date2'];
$sql = mysql_query ("select  * from contratual  where data BETWEEN   '$data' and '$data2' order by supervisor,tec asc; " );
...
$sql3 =  mysql_query ("select  count(*) as conta from contratual where data BETWEEN   '$data' and '$data2' ; " );
