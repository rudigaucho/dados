...
<body>
  ...
  <span style="margin-left: 15%;"><strong> CONSULTA DE PREVENTIVAS POR PERÍODO</strong></span><br><br>

  <form class="form-inline" role="form"   method="POST" action="pesq_per_prev.php" style="margin-left:10%;">
...
$data = $_POST['date'];
$data2 = $_POST['date2'];
$sql = mysql_query ("select  * from repetida  where data BETWEEN   '$data' and '$data2' and tratada = 'SIM' order by ga asc; " );
...
$sql3 =  mysql_query ("select  count(*) as conta from repetida where data BETWEEN   '$data' and '$data2' and tratada = 'SIM' ; " );
