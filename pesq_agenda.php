...
<body>
  ...
  <span style="margin-left: 15%;"><strong> CONSULTA DE AGENDAMENTOS</strong></span><br><br>

  <form class="form-inline" role="form"   method="POST" action="pesq_agenda.php" style="margin-left:10%;">
...
$data = $_POST['date'];
$data2 = $_POST['date2'];
$sql = mysql_query ("select  * from agenda  where data BETWEEN   '$data' and '$data2' and id_ga = '".$_SESSION["tr"]."' order by tec asc; " );
...
$sql3 =  mysql_query ("select  count(*) as conta from agenda where data BETWEEN   '$data' and '$data2' and id_ga = '".$_SESSION["tr"]."' ; " );
...
<td><a  data-toggle="modal" href="#myModal<?php echo $dado ['protocolo'];  ?>" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"> </a></td>
  ...
  <td> <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal3<?php echo $dado ['protocolo'];  ?>" >ATUALIZAR</button> </td>
  ...
  <div class="modal fade" id="myModal_status<?php echo $dado ['protocolo'];  ?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
<a  class="btn btn-danger" href="encerra.php?enc=<?php echo $dado ['protocolo'];?>" role="button" >SIM</a>
...
<div class="modal fade" id="myModal3<?php echo $dado ['protocolo'];  ?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <h4 class="modal-title" style="text-align:center">ATUALIZAÇÃO<h4>
         <form role="form" id="form" name="seachform" method="post" action="pesq_agenda.php " >
  <div class="form-group" >
