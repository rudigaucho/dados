...
<div class="jumbotron text-center " id="jumbo">
  ...
  <span style="margin-left: 15%;"><strong> CADASTRO DE PREVENTIVA</strong></span><br><br>
...
<div class="row content">
  ...
  <form class="form" role="form" name="seachform" method="post" action="enviar_prev.php " enctype="multipart/form-data" >
