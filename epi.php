...
<div class="row"> <!-- 6 + 6 = 12 -->
  ...
  <span><strong>CONTROLE DE EQUIPAMENTOS</strong></span>
    <thead>
      <tr >
       <th>ID</th>
      <th>UF</th>
...
$sql = mysql_query ("select * from check_eqp  ORDER BY gestor asc" );
...
$sql = mysql_query ("select * from check_eqp where gestor = '".$_SESSION['nome']."' ORDER BY nome asc" );
